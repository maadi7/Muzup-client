...
export default function PostComposer({
  ...
  const incrementRefetchSignal = useFeedStore((state) => state.incrementRefetchSignal);
  ...
  const getInitial = () => {
    const name = (currentUser?.name || "You") as string;
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          {currentUser?.profilePic && !imgError ? (
            <img
              ...
              alt={(currentUser?.name || "You") + "'s avatar"}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 relative">
            ...
            >
              ...
              <input id="file-input" type="file" accept="image/*,video/*,audio/*" onChange={onFileChange} className="hidden" />
            </label>
              ...
              {showEmojiPicker && (
                <div
                  ...
                  style={{
                    ...
                    transition: "transform 180ms cubic-bezier(.2,.9,.25,1), opacity 180ms",
                  }}
                >
                  {/* little arrow */}
                  ...
                  <div className="mt-2 text-xs text-subTextColor text-center">Click an emoji to insert</div>
                </div>
              )}
            </div>
          ...
          <div className="flex items-center gap-3">
            {file && (
              <div className="flex items-center gap-2 px-3 py-2 bg-background/40 rounded-full">
                ...
                <button onClick={clearFile} className="text-xs text-subTextColor hover:text-red-400 transition-colors ml-1">
                  ✕
                </button>
              </div>
            )}
              ...
              <div className="flex items-center gap-2">
                <div className="relative w-8 h-8">
                  <svg className="w-8 h-8 transform -rotate-90" viewBox="0 0 32 32">
                    <circle cx="16" cy="16" r="14" fill="none" stroke="var(--background)" strokeWidth="2" />
                    <circle
                      cx="16"
                      cy="16"
                      r="14"
